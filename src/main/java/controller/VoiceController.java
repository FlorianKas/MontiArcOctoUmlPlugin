...
public class VoiceController {
  ...
  // get the name the user wants to name the class or package during naming in
  // NodeConroller
  ...
  public void initVoice() {
    ...
    if (config == 0) {
      ...
      configuration.setGrammarPath("file:C:/Users/Marcus/Documents/mthubrepo/PenguinUML"); // Home
                                                                                           // PC
  ...
  // return which tools that are recognised or sets a name on a class or
  // package, from the voice-input
  ...
  private void voice() { // change to the tool that are recognised from the
                         // voice-input
