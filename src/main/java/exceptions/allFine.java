...
public class allFine implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.ALL_FINE;
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        allFine.this.handleActionClickOnPane();
      }
    });
  }
