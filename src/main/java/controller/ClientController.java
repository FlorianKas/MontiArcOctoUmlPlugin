...
/**
 * Communicates changes in the graph to and from the host. Used by
 * MainController when connecting to a host.
 */
public class ClientController implements PropertyChangeListener {
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (propertyName.equals(Constants.sketchAdd)) {
      String[] dataArray = { Constants.sketchAdd }; // Because serializing
                                                    // Sketch was tricky
