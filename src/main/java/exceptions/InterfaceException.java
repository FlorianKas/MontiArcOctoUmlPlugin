...
public class InterfaceException implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.PORT_IS_MISSING;
  private AbstractNode tmpNode;
  private AbstractNodeView tmpNodeView;
  
  public InterfaceException(AbstractNode node, AbstractNodeView nodeView)
  {
    this.tmpNode = node;
  ...
  public String getContentMessage() {
    return "For an interface, there needs to be at least one port";
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        InterfaceException.this.handleActionClickOnPane();
      }
    });
  }
