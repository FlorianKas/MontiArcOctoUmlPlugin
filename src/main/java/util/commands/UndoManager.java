/*******************************************************************************
 * JetUML - A desktop application for fast UML diagramming. Copyright (C) 2016
 * by the contributors of the JetUML project. See:
 * https://github.com/prmr/JetUML This program is free software: you can
...
public class UndoManager {
  private Stack<Command> aPastCommands; // the commands that have been input and
                                        // can be undone
  private Stack<Command> aUndoneCommands; // the commands that have been undone
                                          // and can be redone
  private Stack<CompoundCommand> aTrackingCommands; // used for many commands
                                                    // coming at once
  private boolean aHoldChanges = false; // turned on while undoing or redoing to
                                        // prevent duplication
  
  private UMLDiagramLogger UMLDiagramLogger;
  
  /**
   * Creates a new UndoManager with the GraphPanel. These should be assigned one
   * per panel.
   */
  public UndoManager() {
  ...
  /**
   * Adds a command to the stack to be undone. Wipes the redone command if there
   * is anything there. Will not add the command if changes are being held,
   * which occurs when we are in the middle of executing a command.
   * 
  ...
  /**
   * Creates a compound command that all coming commands will be added to. Used
   * to perform many commands at once
   */
