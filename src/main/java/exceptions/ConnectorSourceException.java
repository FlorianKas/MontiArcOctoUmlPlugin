...
public class ConnectorSourceException implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.CONNECTOR_SOUCRE_IS_MISSING;
  private AbstractNode tmpNode;
  private AbstractNodeView tmpNodeView;
  
  public ConnectorSourceException(AbstractNode node, AbstractNodeView nodeView)
  {
    this.tmpNode = node;
  ...
  public String getContentMessage() {
    return "Connector Source is missing";
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        ConnectorSourceException.this.handleActionClickOnPane();
      }
    });
  }
