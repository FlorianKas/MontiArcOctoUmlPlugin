...
public class CompoundCommand implements Command {
  ...
  /**
   * Undoes each command on the stack. Puts them in a temporary stack and pops
   * them to retain the order
   */
  public void undo() {
  ...
  /**
   * Executes each command on the stack. Puts them in a temporary stack and pops
   * them to retain the order
   */
  public void execute() {
    Stack<Command> temp = new Stack<>();
