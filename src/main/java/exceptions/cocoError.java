...
public class cocoError implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.COCO_EXCEPTION;
  private String content ="";
  private String contentMessage;
  
  public cocoError(String string)
  {
    this.content = string;
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        cocoError.this.handleActionClickOnPane();
      }
    });
  }
