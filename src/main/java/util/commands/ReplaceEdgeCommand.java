...
public class ReplaceEdgeCommand implements Command {
   ...
   * Creates the command.
   */
  public ReplaceEdgeCommand(AbstractEdge pOldEdge, AbstractEdge pNewEdge, AbstractEdgeView pOldEdgeView, AbstractEdgeView pNewEdgeView, AbstractDiagramController pController, Graph pGraph) {
    oldEdge = pOldEdge;
    newEdge = pNewEdge;
