...
public class UMLDiagramLogger {
  ...
  public UMLDiagramLogger() {
    ...
    try {
      ...
      writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(System.getProperty("user.dir") + File.separator + "log" + File.separator + "OctoUMLLog" + time + ".csv"), "utf-8"));
    }
    catch (Exception e) {
      e.printStackTrace();
    }
