...
public class MessageEdgeView extends AbstractEdgeView {
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (propertyName.equals(Constants.changeNodeTranslateX) || propertyName.equals(Constants.changeNodeTranslateY) || propertyName.equals(Constants.changeEdgeDirection)) {
      draw();
    }
