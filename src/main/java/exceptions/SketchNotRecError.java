...
public class SketchNotRecError implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.SKETCH_NOT_REC;
  
  public SketchNotRecError()
  {
    setPane();
  }
  @Override
  public String getContentMessage() {
    return "Some Sketches could not be recognized. Draw them again";
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        SketchNotRecError.this.handleActionClickOnPane();
      }
    });
  }
