...
public class genTypeWrong implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.GEN_TYPE_WRONG_EXCEPTION;
  private String content ="";
  private String contentMessage;
  
  public genTypeWrong(String string)
  {
    this.content = string;
  ...
  public String getContentMessage() {
    return "Generics " + contentMessage;
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        genTypeWrong.this.handleActionClickOnPane();
      }
    });
  }
