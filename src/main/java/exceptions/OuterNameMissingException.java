...
public class OuterNameMissingException implements MontiCoreException {
  ...
  public OuterNameMissingException()
  {
    setPane();
  }
  @Override
  public String getContentMessage() {
    return "Name of outermost Component is missing";
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        OuterNameMissingException.this.handleActionClickOnPane();
      }
    });
  }
