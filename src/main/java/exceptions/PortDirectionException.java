...
public class PortDirectionException implements MontiCoreException {
  private Pane tmpPane; 
  private MontiArcPlugInErrors.ExceptionType type = MontiArcPlugInErrors.ExceptionType.PORT_DIRECTION_NOT_SET;
  private AbstractNode tmpNode;
  private AbstractNodeView tmpNodeView;
  
  public PortDirectionException(AbstractNode node, AbstractNodeView nodeView)
  {
    this.tmpNode = node;
  ...
  public String getContentMessage() {
    return "Direction of port is not set";
  }
  ...
  private void setPane() {
    ...
    this.tmpPane.setOnMouseClicked(new EventHandler() {
      ...
      public void handle(Event arg0) {
        PortDirectionException.this.handleActionClickOnPane();
      }
    });
  }
